...
export const MAP_PRODUCTS_TO_COMPANIES = 'SELECT Products.name AS productName, Suppliers.companyName FROM Products INNER JOIN Suppliers ON Products.supplierID=Suppliers.supplierID;'
